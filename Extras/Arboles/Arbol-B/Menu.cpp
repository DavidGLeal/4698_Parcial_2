...
void Menu::menuOrden(){
	...
	const char *titulo4 = "****  A R B O L  B ****";
   	const char *opciones4[] = {"Agregar por teclado","Agregar por Archivo", "Imprimir elementos Inorden","Grafico","Borrar Numero","Borrar por archivo","Guardar por archivo","Reiniciar programa","Sumar Primos del arbol","""Regresar"};
	int n4 = 10;
    int orden;
	int numero;//para agregar
	ArbolB A;
