...
int opc=0;
   ...
   const char *titulo2 = "****  M E N U   I N I C I A L ****";
   const char *opciones2[] = {"Ver usuarios registrados", "Registrar usuario nuevo", "Ingresar al sistema", "Salir"};
   int n2 =4 ; // Número de opciones
   
    do {
        
        opc = s.menu(titulo2,opciones2,n2);
         system("cls");
        switch(opc) {
            case 1:{
             	menuListarUsuarios();
            ...
            case 4:{
            	cout<<endl<<endl;
					...
					cout<<"\t\t>> Grupo 14: Jeanhela Nazate, Milena Maldonado"<<endl;
					cout<<"\t\t>> Grupo  7: Brandon Masacela, Juan Reyes "<<endl;
					cout<<"\t\t>> Grupo 10: Sebastián Torres, Shared Tinoco "<<endl;
					cout<<"\t\t>> Grupo 11: Johan Romo, Cristhopher Villamarín "<<endl;
...
void Usuario::menuRegistrarUsuario(){
	bool repite = true;
 	int opc=0;
 	Complemento s;
        // T�tulo y las opciones del men�
   const char *titulo7 = "*******************************";
   const char *opciones7[] = {"Registrar usuario", "Regresar"};
   int n7 = 2; // N�mero de opciones
    
    do {     
       opc=s.menu(titulo7,opciones7,n7);
        system("cls");
