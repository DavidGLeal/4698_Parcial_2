...
#include "Orden_Tituana_Lizardo.cpp"
#include "0Vector.cpp"
...
void MenuOrdenamientos(){
   ...
   const char *opciones[] = {"Ingresar Datos", "Ordenar por Intercambio", "Ordenar por Burbuja", "Ordenar por Quicksort", "Ordenar por ShellSort","Ordenar por Distribucion","Ordenar por Radix","Prueba","Regresar al menu principal"};
   int n = 9;  
