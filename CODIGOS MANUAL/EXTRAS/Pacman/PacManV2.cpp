...
void llenarTeclado()
{
	...
	for (int i = 0; i < 22; i++)
	{
		for (int j = 0; j < 6; j++)
		{
			...
			else if (teclado[j][i] == 'b')
			{
				setColor(color[0]);
				cout << char(187);
			}
			else if (teclado[j][i] == 'c')
			{
				setColor(color[0]);
				cout << char(200);
			}
			else if (teclado[j][i] == 'd')
			{
				setColor(color[0]);
				cout << char(188);
			}
			else if (teclado[j][i] == 'e')
			{
				setColor(color[0]);
				cout << char(94);
			}
			else if (teclado[j][i] == 'f')
			{
				setColor(color[0]);
				cout << char(60);
			}
			else if (teclado[j][i] == 'g')
			{
				setColor(color[0]);
				cout << char(62);
			}
			else if (teclado[j][i] == 'h')
			{
				setColor(color[0]);
				cout << 'v';
			}
...
char tablero[29][51] =
{
	"AxxxxxxxxxxxxxxxxxxxxxxB AxxxxxxxxxxxxxxxxxxxxxxB",
	"I_________++___________I I___________++_________I",
	"I__AxxxxxB__AxxxxxxxB__I I__AxxxxxxxB__AxxxxxB__I",
	"I__I     I__I       I__I I__I       I__I     I__I",
	"I__DxxxxxC__DxxxxxxxC__DxC__DxxxxxxxC__DxxxxxC__I",
	"I++_______++___++____++___++_____++__++_______++I",
	"I__AxxxxxB__AxB__AxxxxxxxxxxxxxB__AxB__AxxxxxB__I",
	"I__DxxxxxC__I I__DxxxxB   AxxxxC__I I__DxxxxxC__I",
	"I_________++I I_______I   I_______I I++_________I",
	"DxxxxxxxxB__I DxxxxB  I   I  AxxxxC I__AxxxxxxxxC",
	"         I__I AxxxxC  DxxxC  DxxxxB I__I         ",
	"         I__I I                   I I__I         ",
	"xxxxxxxxxC__DxC  Axxxxxx xxxxxxB  DxC__Dxxxxxxxxx",
	"          ++     I      *      I     ++          ",
	"xxxxxxxxxB__AxB  DxxxxxxxxxxxxxC  AxB__Axxxxxxxxx",
	"         I__I I                   I I__I         ",
	"         I__I I  AxxxxxxxxxxxxxB  I I__I         ",
	"AxxxxxxxxC__DxC  DxxxxB   AxxxxC  DxC__DxxxxxxxxB",
	"I_________++__________I   I__________++_________I",
	"I__AxxxxxB__AxxxxxxB__I   I__AxxxxxxB__AxxxxxB__I",
	"I__DxxxB I__DxxxxxxC__DxxxC__DxxxxxxC__I AxxxC__I",
	"I______I I++________++_____++________++I I______I",
	"DxxxB__I I_ Ax Ax AxxxxxxxxxB AB Ax  __I I__AxxxC",
	"AxxxC__DxC_ Ex DB DxB     AxC EC Ex  __DxC__DxxxB",
	"I____++____ Dx xC   I     I   I  Dx  _____++____I",
	"I__AxxxxxxxxxxxxxxB__I    I___AxxxxxxxxxxxxxxB__I",
	"I__DxxxxxxxxxxxxxxC__DxxxxC___DxxxxxxxxxxxxxxC__I",
	"I__________________++______+++__________________I",
...
void menuAyuda()
{
	...
	cout << "    vidas el juego se dara por terminado." << endl
		 << endl
		 << endl;
...
void imprimirPacman(int i, int j)
{
	...
	if (dir == 0)
	{
		tablero[i][j] = 255; // V118
		grafico.DibujarPacman(106+9*i,90+20*j,grafico.AMARILLO,2);
	}
	else if (dir == 1)
	{
		tablero[i][j] = 255; //^94
		grafico.DibujarPacman(106+9*i,90+20*j,grafico.AMARILLO,3);
	}
	else if (dir == 2)
	{
		tablero[i][j] = 255; //<60
		grafico.DibujarPacman(106+9*i,90+20*j,grafico.AMARILLO,0);
	}
	else if (dir == 3)
	{
		tablero[i][j] = 255; //62;//>62
		grafico.DibujarPacman(106+9*i,90+20*j,grafico.AMARILLO,1);
	}
...
{
	setColor(color[4]);
	tablero[iC][jC] = 255;//67;
	grafico.DibujarFantasma(106+9*iC,80+20*jC,grafico.CYAN);
	//gotoxy(11 + iC, 4 + jC);
	//cout << tablero[iC][jC];
}
...
{
	setColor(color[1]);
	tablero[iB][jB] = 255;//66;//66
	grafico.DibujarFantasma(106+9*iB,80+20*jB,grafico.ROJO);
	//gotoxy(11 + iB, 4 + jB);
	//cout << tablero[iB][jB];
}
...
main()
{
	...
	while (respuesta == 's' || respuesta == 'S')
	{
		...
		if (dirMenu == 1 || dirMenu == 2 || dirMenu == 3)
		{
			...
			gotoxy(0, 0);
			// cout << PlaySoundA((LPCSTR)soundPacManInicio, NULL, SND_FILENAME | SND_ASYNC);
			gotoxy(0, 0);
			cout << " ";
			//Sleep(4700);
